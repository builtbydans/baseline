...
export const COPY: Record<AppMode, AppCopy> = {
  professional: {
    ...
    dashboard: {
      ...
      chartDescription: "Speech clarity is rising while filler-word counts fall.",
      claritySeries: "Speech clarity %",
    ...
    setup: {
      title: "Session setup",
      description:
        "Choose a topic for interview practice. Baseline will analyze a live assessment.",
  ...
  clinical: {
    ...
    dashboard: {
      ...
      chartDescription:
        "Speech clarity and gaze stability are improving week over week.",
      claritySeries: "Speech clarity %",
